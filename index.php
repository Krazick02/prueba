...
<body background-color="yellow" onload="relog()">
    ...
    <script type ="text/javascript">
        ...
        var min=0;
        var coordsCor=[[420,15,20,20],[450,15,20,20],[480,15,20,20]];
        var seg=0;
        var direction='left';
        var dir01='left';
        var dir02='rigth';
        ...
        function start(){
            ...
            for (var i = 0; i < life; i++) {
                var n=new Cuadraro(coordsCor[i][0],coordsCor[i][1],coordsCor[i][2],coordsCor[i][3],"white");
                corazones.push(n);
            }
        ...
        function paint(){
            ...
            for (var i = 0; i < life; i++) {
                corazones[i].dibujar(ctx);
                ctx.drawImage(corazon,corazones[i].x,corazones[i].y,corazones[i].w,corazones[i].h);
            }
